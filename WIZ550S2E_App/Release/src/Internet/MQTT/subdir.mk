...
C_SRCS += \
../src/Internet/MQTT/MQTTClient.c \
../src/Internet/MQTT/mqtt_interface.c 

OBJS += \
./src/Internet/MQTT/MQTTClient.o \
./src/Internet/MQTT/mqtt_interface.o 

C_DEPS += \
./src/Internet/MQTT/MQTTClient.d \
./src/Internet/MQTT/mqtt_interface.d 


# Each subdirectory must supply rules for building sources it contributes
src/Internet/MQTT/%.o: ../src/Internet/MQTT/%.c
	@echo 'Building file: $<'
